                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                                    ...
                                    <div class="slimscroll notification-item-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                            ...
                                            <p class="notify-details">New Student SignIn<span class="text-muted"><?php echo $tstudactive; ?> are pending to verify</span></p>
                                        </a>
                        ...
                        <div class="card mini-stat bg-primary">
                            <div class="card-body mini-stat-img">
                                ...
                                <div class="text-white">
                                    ...
                                    <h4 class="mb-4"><?php echo $tevent; ?></h4>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card mini-stat bg-primary">
                            <div class="card-body mini-stat-img">
                                ...
                                <div class="text-white">
                                    <h6 class="text-uppercase mb-3">Media Uploaded</h6>
                                    <h4 class="mb-4"><?php echo $tmedia; ?></h4>
                        ...
                        <div class="card mini-stat bg-primary">
                            <div class="card-body mini-stat-img">
                                ...
                                <div class="text-white">
                                    ...
                                    <h4 class="mb-4"><?php echo $tstud; ?></h4>
                                    <span class="badge badge-warning"> 60% </span> <span class="ml-2">From previous period</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6">
                        <div class="card mini-stat bg-primary">
                            <div class="card-body mini-stat-img">
                                ...
                                <div class="text-white">
                                    <h6 class="text-uppercase mb-3">Organisations</h6>
                                    <h4 class="mb-4"><?php echo $torg; ?></h4>
                                    <span class="badge badge-info"> +90% </span> <span class="ml-2">From previous period</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        © 2019 FORTE - <span class="d-none d-sm-inline-block"> Crafted with <i class="mdi mdi-heart text-danger"></i> by Ria, Priyal and Sherine</span>.
                    </div>
                </div>
            </div>
        </footer>
